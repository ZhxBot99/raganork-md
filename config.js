...
module.exports = {
    ...
    STICKER_DATA: process.env.STICKER_DATA || "ZhxBot",
    BOT_NAME: process.env.BOT_NAME || 'ZhxBot',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? 'ꪶ͢٭VIP BOT¹¹ꫂ;ZhxDev MD bot;https://i.imgur.com/P7ziVhr.jpeg' : process.env.AUDIO_DATA,
